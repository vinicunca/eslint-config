...
- [eslint-comments](/config/eslint-comments)
- [node](/config/node)
- [jsdoc](/config/jsdoc)
- [imports](/config/imports)
- [unicorn](/config/unicorn)
- [typescript](/config/typescript)
- [stylistic](/config/stylistic)
- [test](/config/test)
- [vue](/config/vue)
- [jsonc](/config/jsonc)
- [sort-package-json](/config/sort-package-json)
- [sort-tsconfig](/config/sort-tsconfig)
- [yaml](/config/yaml)
- [markdown](/config/markdown)
- [react](/config/react) (disabled by default)
